 ...
 */
public class telaDeTransferencia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Digite o número da conta(CC):");
    ...
    private void confirmaDepositoButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_confirmaDepositoButtonMouseClicked
        try {
            Conta.logado.transferir(txtContaAlvo.getText(), Double.parseDouble(txtValor.getText()));
        } catch (InterruptedException | SQLException ex) {
            Logger.getLogger(telaDeTransferencia.class.getName()).log(Level.SEVERE, null, ex);
        }
