 ...
 */
public class telaCDB extends javax.swing.JFrame {

    /**
     * Creates new form telaDeSaque
     */
    public telaCDB() throws ParseException {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 350, 70, 20));
        ...
        jLabel3.setText("Digite o código do CDB:");
    ...
    private void confirmaDepositoButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_confirmaDepositoButtonMouseClicked
        try {
            CDB.depositarCDB(txtFundo.getText(), Double.parseDouble(txtValor.getText()));
        } catch (SQLException ex) {
            Logger.getLogger(telaCDB.class.getName()).log(Level.SEVERE, null, ex);
        }
