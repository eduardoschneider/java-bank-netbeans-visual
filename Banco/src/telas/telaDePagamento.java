...
public class telaDePagamento extends javax.swing.JFrame {
     ...
     */
    public telaDePagamento() throws ParseException {
    ...
    private void initComponents() {
        ...
        confirmaPagamentoButton = new javax.swing.JButton();
        ...
        txtContaAlvo.setText("000.000.000.000.00.0");
        txtContaAlvo.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jPanel1.add(txtContaAlvo, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 320, 150, 20));

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Digite o código do doc.:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 300, 160, 20));
        ...
        confirmaPagamentoButton.setBackground(new java.awt.Color(0, 153, 0));
        confirmaPagamentoButton.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        confirmaPagamentoButton.setForeground(new java.awt.Color(255, 255, 255));
        confirmaPagamentoButton.setText("OK");
        confirmaPagamentoButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                confirmaPagamentoButtonMouseClicked(evt);
            }
        });
        confirmaPagamentoButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                confirmaPagamentoButtonActionPerformed(evt);
            }
        });
        jPanel1.add(confirmaPagamentoButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 350, 80, 20));
        ...
        jLabel2.setText("Digite o valor do documento:");
    ...
    private void confirmaPagamentoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmaPagamentoButtonActionPerformed
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            public void run() {
                ...
                confirmaPagamentoButton.setBackground(new Color(0,102,0));
            }
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            public void run() {
                ...
                confirmaPagamentoButton.setBackground(new Color(0,153,0));
            }
    ...
    }//GEN-LAST:event_confirmaPagamentoButtonActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        close();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void confirmaPagamentoButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_confirmaPagamentoButtonMouseClicked
        try {
            Conta.logado.pagarBoleto(Double.parseDouble(txtValor.getText()));
        } catch (SQLException ex) {
            Logger.getLogger(telaDePagamento.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_confirmaPagamentoButtonMouseClicked
    ...
    private javax.swing.JButton confirmaPagamentoButton;
